    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {!user && (
            <Link to="/sign-in">
              <Button size="sm" className="font-body font-semibold px-5">Log In</Button>
            </Link>
          )}
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-background border-b border-border px-4 pb-4 space-y-1">
          ...
          {user && (
            <Button variant="ghost" className="w-full justify-start gap-3 font-body text-muted-foreground"
